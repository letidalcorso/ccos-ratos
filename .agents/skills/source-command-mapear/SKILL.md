---
name: "source-command-mapear"
description: "Entrevista o usuário sobre seus processos repetitivos e cria pastas e skills personalizadas pro dia a dia dele. Rodar depois do /setup. Use quando o usuário chamar /mapear, quando disser \"quero organizar meus processos\", \"quero criar skills\", \"mapear tarefas\", ou \"personalizar o ambiente\"."
---

# source-command-mapear

Use this skill when the user asks to run the migrated source command `mapear`.
...
**2. Catálogo de skills externas** (`templates/skills/catalogo.md`) — skills globais ou nativas do Codex que já estão prontas.
...
> - [Instalar a skill `/newsletter` em .Codex/skills/newsletter/SKILL.md] (se aplicável)
...
Quando a 3.1 não encontrou nem template nem skill externa que sirva, **invocar a skill-creator nativa do Codex via Skill tool** ao invés de tentar escrever a skill na mão. A skill-creator é especialista em estruturar skills com os princípios certos (concisão, degrees of freedom, anatomia correta de bundled resources).
...
- **Onde salvar** — `.Codex/skills/nome-da-skill/SKILL.md`
...
Salvar em `.Codex/skills/nome-da-skill/SKILL.md` (local do projeto).
