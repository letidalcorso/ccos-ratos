---
name: "source-command-syncar"
description: "Salva o estado atual do workspace no GitHub (commit + push). Use quando quiser garantir que o trabalho está seguro, ao final de uma sessão produtiva, ou quando o usuário disser \"salva no github\", \"faz commit\", \"synca\", \"syncar\", \"backup no github\", \"salva tudo\", \"manda pro github\". Também configura o git pela primeira vez se ainda não estiver configurado."
---

# source-command-syncar

Use this skill when the user asks to run the migrated source command `syncar`.
