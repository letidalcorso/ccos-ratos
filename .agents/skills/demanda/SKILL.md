...
- **Contexto do cliente:** `clientes/[cliente]/AGENTS.md` — carregar conforme o cliente identificado
...
Carregar imediatamente `clientes/[cliente]/AGENTS.md`.

Se o cliente não estiver claro no texto:
> "Essa demanda é de qual cliente?"

**2.2 — Interpretar a demanda**
Com o contexto do AGENTS.md do cliente em mãos, interpretar:
...
Gerar o texto do entregável com base no contexto do cliente (AGENTS.md) e na demanda confirmada:
...
- Identidade visual do cliente conforme AGENTS.md
...
**Nunca gerar SVG diretamente** — SVG gerado pelo Codex tem qualidade inconsistente e sempre precisa de ajuste manual. Figma MCP ou HTML→PNG são as opções.
...
- Tom e estilo sempre pelo AGENTS.md do cliente — sem inventar nada fora do briefing
