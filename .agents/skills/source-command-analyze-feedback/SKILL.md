---
name: "source-command-analyze-feedback"
description: "Analyze user feedback at scale — sentiment analysis, theme extraction, and segment-level insights"
---

# source-command-analyze-feedback

Use this skill when the user asks to run the migrated source command `analyze-feedback`.
