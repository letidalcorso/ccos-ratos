---
name: "source-command-value-proposition"
description: "Design a value proposition using the 6-part JTBD template — Who, Why, What before, How, What after, Alternatives"
---

# source-command-value-proposition

Use this skill when the user asks to run the migrated source command `value-proposition`.
