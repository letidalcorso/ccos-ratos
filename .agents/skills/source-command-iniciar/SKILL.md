---
name: "source-command-iniciar"
description: "Inicia a sessão de trabalho lendo o contexto do negócio e ajudando o usuário a começar. Usar no começo de cada sessão nova do Codex."
---

# source-command-iniciar

Use this skill when the user asks to run the migrated source command `iniciar`.
