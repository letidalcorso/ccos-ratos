---
name: "source-command-competitive-analysis"
...
# source-command-competitive-analysis

Use this skill when the user asks to run the migrated source command `competitive-analysis`.
