...
# source-command-ftemper

Use this skill when the user asks to run the migrated source command `ftemper`.
...
1. Ler `clientes/ftemper/AGENTS.md` — contexto geral do cliente
