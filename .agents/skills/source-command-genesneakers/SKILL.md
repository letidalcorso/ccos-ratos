---
name: "source-command-genesneakers"
...
# source-command-genesneakers

Use this skill when the user asks to run the migrated source command `genesneakers`.
...
1. Ler `clientes/genesneakers/AGENTS.md` — contexto geral do cliente
