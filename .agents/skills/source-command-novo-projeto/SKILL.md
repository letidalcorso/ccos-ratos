---
name: "source-command-novo-projeto"
description: "Cria uma nova pasta de projeto com AGENTS.md personalizado. Entrevista o usuário sobre o projeto, gera a estrutura e referencia no AGENTS.md principal. Use quando o usuário chamar /novo-projeto, disser \"novo cliente\", \"novo projeto\", \"criar pasta pro cliente X\", \"vou começar um projeto novo\", ou quando precisar organizar um trabalho novo em pasta separada."
---

# source-command-novo-projeto

Use this skill when the user asks to run the migrated source command `novo-projeto`.

## Command Template

# /novo-projeto — Criar novo projeto com contexto

Cria uma pasta de projeto com AGENTS.md dedicado, entrevistando o usuário sobre o que é o projeto.
...
### Passo 3: Criar a pasta e o AGENTS.md

Criar a pasta e gerar o AGENTS.md do projeto:
...
AGENTS.md: clientes/fabio-haag/AGENTS.md
Referência: adicionado na estrutura de pastas do AGENTS.md principal

Pra trabalhar nesse projeto, é só falar. O Codex já vai ler o contexto da pasta.
```
...
- Se o usuário já criou a pasta manualmente, só gerar o AGENTS.md dentro dela
