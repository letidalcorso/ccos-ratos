...
- **Contexto do cliente:** `clientes/[nome-cliente]/CLAUDE.md` — tom visual, referências
...
> "A identidade visual de [cliente] ainda não foi criada. Quer rodar `/identidade-visual` primeiro ou prefere que eu use um estilo temporário baseado no CLAUDE.md do cliente?"
