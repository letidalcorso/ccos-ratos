...
1. Ler `clientes/[nome-cliente]/CLAUDE.md` — contexto, tom, pilares, referências
...
- Ao final de qualquer modo, verificar se o CLAUDE.md do cliente precisa ser atualizado
