...
- **Herói atual (atualizado 13/06):** o 17 Pro Max laranja seminovo FOI VENDIDO. **Não há mais nenhum 17 Pro Max seminovo em estoque.** Herói agora = **iPhones novos lacrados da linha 17** (inclui 17 Pro Max). Preço: mostrar Pix + parcelado (juros embutidos, não anunciar "sem juros"), nunca esconder o Pix. **Regra de bateria:** vale só pra seminovo quando houver; nunca prometer "100%" como padrão. **Copy vencida (não usar):** "seminovo", "dois seminovos", "o último laranja", "100% de bateria". Seminovo segue sob encomenda/avaliação (oferta secundária, nunca herói); trade-in aceita a partir do iPhone 11. **Todo seminovo sai com 3 meses de garantia da loja** (por cima da garantia Apple) — pode usar em copy/atendimento/blog.
...
- **Copa do Mundo (11/06 a 19/07):** fio condutor cultural recorrente, sempre por comportamento real (segundo telão, câmera, bateria), nunca metáfora forçada. O post "se a seleção fosse apple" (06/06) floppou por ser metáfora vazia.
- **Métricas:** acompanhar em `conteudo/tracker-conteudo-junho.md`. Régua: salvamento (~3x curtida) e envio (sinal viral 2026) valem; curtida quase ignora. Revisão semanal toda sexta 16h (evento recorrente na agenda). Pivot: 20/06 olhar tendência, fim do mês olhar conversão.
...
**NAP canônico (usar idêntico em GMB, site e Instagram):** Smartbase · Rua Sinimbu, 2211 — sala 805, Centro, Caxias do Sul/RS, CEP 95020-520 · (54) 99662-4494 (só WhatsApp) · Seg a Sex, 9h–19h. Detalhes em `gmb-go-live.md`.
